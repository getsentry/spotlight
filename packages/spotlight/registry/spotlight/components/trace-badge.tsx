...
import type { TraceBadgeProps } from "@/registry/spotlight/lib/types";
 ...
 *
 * @example
 * <TraceBadge variant="status" value="ok" />
 * <TraceBadge variant="status" value="error" />
 * <TraceBadge variant="method" value="GET" />
 * <TraceBadge variant="environment" value="production" />
 */
