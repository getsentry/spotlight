...
import type { TimeSinceProps } from "@/registry/spotlight/lib/types";
 ...
 * // Renders: "2 minutes ago"
 *
 * @example
 * <TimeSince date={new Date()} refreshInterval={1000} className="text-sm" />
 * // Renders: "a few seconds ago" and updates every second
 */
