import { isDebugEnabled, logger } from "@spotlight/sidecar/logger.js";
import { type ParsedEnvelope, type SentryErrorEvent, type SentryEvent, isErrorEvent } from "@spotlight/sidecar/parser/index.js";
