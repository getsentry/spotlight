...
If you're Astro application is interacting with other services, such as a Python API, you can also configure those SDKs to work with Spotlight. You don't need to be using the Sentry service to take advantage of Sentry's SDKs to power Spotlight.
