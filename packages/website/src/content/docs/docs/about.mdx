...
The original "overlay" concept has evolved. Spotlight now provides a [Desktop App](/docs/desktop-app/) and [CLI](/docs/cli/) with a browser-based UI instead of an embedded overlay.
:::
...
[^2]: If you don't have `npx` around, you can use `docker run -p 8969:8969 ghcr.io/getsentry/spotlight:latest`, or head over to our [GitHub Releases page](https://github.com/getsentry/spotlight/releases/latest) and download a binary for your system. Alternatively, we provide a [Desktop App](/docs/desktop-app/) that bundles everything together. <DownloadButton>Download for Mac</DownloadButton>
