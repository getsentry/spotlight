...
This makes DNS rebinding attacks impractical against Spotlight. Hostnames from `/etc/hosts` (which have no TTL) are trusted since they're under local control.
