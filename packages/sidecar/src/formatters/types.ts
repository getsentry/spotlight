...
/**
 * A formatter function that takes an envelope item payload and returns an array of formatted strings.
 ...
 */
export type FormatterFunction = (payload: EnvelopeItem[1], envelope?: Envelope) => string[];
