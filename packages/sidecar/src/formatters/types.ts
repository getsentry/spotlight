 ...
 * The envelopeHeader is typed as EnvelopeItem[0] which contains metadata like SDK info.
 * Formatters should use type guards (e.g., isErrorEvent, isLogEvent) to narrow the payload type.
 */
export type FormatterFunction = (payload: EnvelopeItem[1], envelopeHeader: EnvelopeItem[0]) => string[];
